...
#define AD7606_RESET_RCC_GPIO_CLK_ENABLE	__HAL_RCC_GPIOB_CLK_ENABLE
#define AD7606_RESET_GPIO		GPIOB
#define AD7606_RESET_PIN		GPIO_PIN_1

#define RESET_1()	AD7606_RESET_GPIO->BSRR=AD7606_RESET_PIN
#define RESET_0()	AD7606_RESET_GPIO->BSRR=((uint32_t)AD7606_RESET_PIN<<16)
...
//	PG0/FMC_A10		--- 和主片选FMC_NE2一起译码
//	PG1/FMC_A11		--- 和主片选FMC_NE2一起译码
	PG12/FMC_NE4		--- 主片选（OLED, 74HC574, DM9000, AD7606）	
...
//	PF0/FMC_A0      ---- RS
	*/	
	...
	AD7606_RESET_RCC_GPIO_CLK_ENABLE();
	/* 设置 GPIOD 相关的IO为复用推挽输出 */
	gpio_init_structure.Mode = GPIO_MODE_OUTPUT_PP;
	gpio_init_structure.Pull = GPIO_PULLUP;
	gpio_init_structure.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
		
	gpio_init_structure.Pin = AD7606_RESET_PIN;
	HAL_GPIO_Init(AD7606_RESET_GPIO, &gpio_init_structure);
...
/* OS0信号 = PA3 */
#define OS0_RCC_GPIO_CLK_ENABLE	__HAL_RCC_GPIOC_CLK_ENABLE
#define OS0_GPIO		GPIOC
#define OS0_PIN		GPIO_PIN_10

/* OS1信号 = PB8 */
#define OS1_RCC_GPIO_CLK_ENABLE	__HAL_RCC_GPIOG_CLK_ENABLE
#define OS1_GPIO		GPIOG
#define OS1_PIN		GPIO_PIN_11

/* OS2信号 = PA5 */
#define OS2_RCC_GPIO_CLK_ENABLE	__HAL_RCC_GPIOB_CLK_ENABLE
...
#define OS0_0()		OS0_GPIO->BSRR=((uint32_t)OS0_PIN<<16)
#define OS1_1()		OS1_GPIO->BSRR=OS1_PIN
#define OS1_0()		OS1_GPIO->BSRR=((uint32_t)OS1_PIN<<16)
#define OS2_1()		OS2_GPIO->BSRR=OS2_PIN
#define OS2_0()		OS2_GPIO->BSRR=((uint32_t)OS2_PIN<<16)

/* CONVST 启动ADC转换的GPIO = PA15 */
#define CONVST_RCC_GPIO_CLK_ENABLE	__HAL_RCC_GPIOA_CLK_ENABLE
#define CONVST_GPIO		GPIOA
#define CONVST_PIN		GPIO_PIN_15
#define CONVST_TIMX		TIM2
...
/* 修改后，可以设置量程大小      设置输入量程的GPIO, 在扩展的74HC574上 */
#define RANGE_RCC_GPIO_CLK_ENABLE	__HAL_RCC_GPIOB_CLK_ENABLE
#define RANGE_GPIO		GPIOB
#define RANGE_PIN		GPIO_PIN_12

/* 设置输入量程的GPIO, 在扩展的74HC574上 */
#define RANGE_1()	RANGE_GPIO->BSRR=RANGE_PIN
#define RANGE_0()	RANGE_GPIO->BSRR=((uint32_t)RANGE_PIN<<16)
...
#define AD7606_RESULT()	*(__IO uint16_t *)0x6C000000  //切记打开相应的mpu
...
//	PF0/FMC_A0      ---- RS
	*/	
	...
	/* 使能 GPIO时钟 */
	OS0_RCC_GPIO_CLK_ENABLE();
	OS1_RCC_GPIO_CLK_ENABLE();
	OS2_RCC_GPIO_CLK_ENABLE();
	...
	gpio_init_structure.Pin = OS0_PIN;
	HAL_GPIO_Init(OS0_GPIO, &gpio_init_structure);
	
	gpio_init_structure.Pin = OS1_PIN;
	HAL_GPIO_Init(OS1_GPIO, &gpio_init_structure);
	
	gpio_init_structure.Pin = OS2_PIN;
	HAL_GPIO_Init(OS2_GPIO, &gpio_init_structure);

	gpio_init_structure.Pin = RANGE_PIN;
	HAL_GPIO_Init(RANGE_GPIO, &gpio_init_structure);
	...
	/* 配置GPIOG */
	gpio_init_structure.Pin = GPIO_PIN_12; //FMC_NE4
